...
class TestMGHBlockchain(unittest.TestCase):
    ...
    def test_genesis_block(self):
        ...
        expected_block_data = "Anna send 1 MGH to Bob | Bob send 2.1 MGH to Charlie | Genesis Block"
        self.assertEqual(genesis_block.block_data, expected_block_data)
        
        # Test expected hash
        expected_hash = "5edce08c5f27ec457650b62fa85c121de34579a8a9b9d0ecbeb13578f1f4f666"
    ...
    def test_second_block(self):
        ...
        genesis_hash = "5edce08c5f27ec457650b62fa85c121de34579a8a9b9d0ecbeb13578f1f4f666"
        ...
        # Test expected hash
        expected_hash = "6c6594358b10e4b9032742a14f85af0bade67ce9854f631a7922d90031f9cff6"
